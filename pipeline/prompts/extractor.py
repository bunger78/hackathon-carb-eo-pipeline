...
- fitment: one row per vehicle-application line in the document's tables or prose.
  ...
  CRITICAL - RESTRICTIONS: when a row or section carries a restriction or limitation clause (e.g. "approval limited to Kit K8625", or restricted to specific part numbers/configurations), capture that restriction in the row's trim_note and reflect the referenced kit/part numbers in that row's part_numbers.
